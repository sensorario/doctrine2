...
abstract class OrmFunctionalTestCase extends OrmTestCase
{
    ...
    protected function setUp()
    {
        ...
        if ( ! isset(static::$sharedConn)) {
            ...
            if (static::$sharedConn->getDriver() instanceof SqliteDriver) {
        ...
        foreach ($this->usedModelSets as $setName => $bool) {
            if ( ! isset(static::$tablesCreated[$setName])/* || $forceCreateTables*/) {
     ...
     */
    protected function getEntityManager($config = null, $eventManager = null)
    {
